...
class FavoritoService {
  ...
  Future<List<Transporte>> getTransportesFavoritos(int id) async {
    ...
    $TRANSPORTE_TABLE_NAME.renavam, $TRANSPORTE_TABLE_NAME.placa, $TRANSPORTE_TABLE_NAME.capacidade, $TRANSPORTE_TABLE_NAME.numero, $TRANSPORTE_TABLE_NAME.favorito
